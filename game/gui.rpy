...
## bottom order.
define gui.namebox_borders = Borders(15, 25, 15, 10)
...
define gui.choice_button_text_idle_color = "#2e2e2e"
define gui.choice_button_text_hover_color = "#ededed"
